 ...
 * usando evaluación perezoza (<em>lazy loading</em>) se guarda a nivel de
 * sesión
 */
public class ServiceLocator {
	 ...
	 */
	private Map<String, ServiceLocator> services = new TreeMap<String, ServiceLocator>();
	 ...
	 * 
	 * @return instancia única de {@link ServiceLocator}
	 * @throws NamingException
	 */
	 ...
	 * @throws NamingException
	 *             Si el nombre no está asociado a un objeto en el contenedor
	 *             web.
	 */
	public Object get(String beanName) throws NamingException {

		ServiceLocator vs = services.get(beanName);
		...
		if (serviceRef == null) {
			...
			services.put(beanName, (ServiceLocator) serviceRef);
		}
