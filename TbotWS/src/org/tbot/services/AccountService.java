...
public class AccountService {
	...
	public String initialize(@WebParam(name = "login") String login,
			@WebParam(name = "pass") String pass,
			@WebParam(name = "server") String Server) throws IOException {

		IAccount dd = null;
		try {
			dd = (AccountRemoteLocal) ServiceLocator.instance().get(
	...
	public Village[] obtenerVillas(
			@WebParam(name = "hashLogin") String hashLogin)
	...
	public Account obtenerCuenta(@WebParam(name = "hashLogin") String hashLogin)
			throws NamingException, IOException {
		IAccount dd = null;
		try {
			dd = (AccountRemoteLocal) ServiceLocator.instance().get(
		...
		return dd.obtenerCuenta(hashLogin);
